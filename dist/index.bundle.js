...
/***/ "./dev_modules/@ocdla/Timer/Timer.js":
/*!*******************************************!*\
  !*** ./dev_modules/@ocdla/Timer/Timer.js ***!
  \*******************************************/
...
var Timer = /*#__PURE__*/function () {
  ...
  function Timer(timestringOrSeconds) {
    ...
    var seconds = timestringOrSeconds;
  ...
  return _createClass(Timer, [{
    ...
    value:
    /*#__PURE__*/
    _regeneratorRuntime().mark(function counter(units) {
      var i;
    ...
    value: function start() {
      ...
      this.interval = setInterval(function () {
        var seconds = _this.g.next().value;
    ...
    key: "render",
    value: function render(seconds) {
      var h, m, s;
      // Parse seconds into hour,min,sec *string notation.
      var _Timer$parse = Timer.parse(seconds);
      var _Timer$parse2 = _slicedToArray(_Timer$parse, 3);
      h = _Timer$parse2[0];
      m = _Timer$parse2[1];
      s = _Timer$parse2[2];
      return [h, m, s];
    ...
    key: "convertTimer",
    value: function convertTimer(sec) {
      var minutes = Math.floor(sec / 6000);
      var seconds = Math.floor(sec / 100) % 60;
      var milliseconds = sec % 100;
...
_defineProperty(Timer, "PRECISION", 1000);
// What sounds does the timer make when done?
_defineProperty(Timer, "TIMER_FINISHED_SOUND", 'BEEP!');
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dev_modules_ocdla_Timer_Timer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../dev_modules/@ocdla/Timer/Timer */ "./dev_modules/@ocdla/Timer/Timer.js");
...
function setTimer() {
  ...
  var cal = calcTimer(parseInt(minutes.value), parseInt(seconds.value), parseInt(miliseconds.value));
  timer = new _dev_modules_ocdla_Timer_Timer__WEBPACK_IMPORTED_MODULE_0__["default"](cal);
...
function calcTimer(minutes, seconds, miliseconds) {
  ...
  if (!isNaN(seconds)) totalMilliseconds += seconds * 100;
  if (!isNaN(miliseconds)) totalMilliseconds += miliseconds;
  //+ (seconds * 1000) + milliseconds;
  return totalMilliseconds;
}
})();
